# 🏔️ WanderVibe — Curated Social Group Travel Platform
...
**WanderVibe** is a verified social group travel platform connecting solo travelers, youth groups, and mountain enthusiasts. We specialize in luxury AC Traveller group departures to Himalayan destinations like **Kasol & Manikaran**, **Manali & Solang Valley**, **Spiti Valley Offroad**, **Kedarkantha Snow Trek**, **Nepal Cross-Border**, and **Meghalaya Camping**.

---

## 🔥 Key Features

- **🔒 40% Advance Seat Lock Gateway**: Lock bus seats with a 40% minimum advance via Razorpay / UPI; pay the remaining 60% balance at boarding.
...
# 4. Start backend SMTP email service (Optional)
node server.js
```
...
© 2026 WanderVibe Social Travel Agency. All Rights Reserved.
